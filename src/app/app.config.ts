...
import { authLogin$, authLoginFromGoogle$, authLogout$, authSetUserInformation$ } from './store/auth/auth.effects';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideEffects({ addPokemon$, authLogin$, authLogout$, authLoginFromGoogle$, authSetUserInformation$ }),
