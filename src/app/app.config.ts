...
import { authLogin$, authLoginFromGoogle$, authSetUserInformation$ } from './store/auth/auth.effects';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideEffects({ addPokemon$, authLogin$, authLoginFromGoogle$, authSetUserInformation$ }),
